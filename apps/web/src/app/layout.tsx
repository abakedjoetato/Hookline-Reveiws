        ...
        <header className="sticky top-0 z-40 w-full border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-md">
          <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-6">
              <Link href="/" className="flex items-center gap-2 font-bold text-lg text-violet-500 font-sans tracking-wide">
                <Radio className="h-5 w-5 animate-pulse" />
                <span>TheQueue</span>
              </Link>
              <nav className="hidden md:flex gap-6 text-sm font-medium text-zinc-400">
                <Link href="/" className="hover:text-zinc-100 transition-colors">Home</Link>
                <Link href="/library" className="hover:text-zinc-100 transition-colors">Music Library</Link>
                <Link href="/hosts" className="hover:text-zinc-100 transition-colors">Live Stations</Link>
                <Link href="/submissions" className="hover:text-zinc-100 transition-colors">Submissions</Link>
              </nav>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 border-l border-zinc-800 pl-4">
                ...
                <span className="hidden sm:inline text-sm font-medium text-zinc-300">User Shell</span>
              </div>
            </div>
          </div>
        </header>
